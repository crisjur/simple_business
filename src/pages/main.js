      ...
      <div class="header js-header">
        <div class="header__center center">
          <a class="header__logo js-header-logo" href="index.html">
            <img class="header__pic" src="logo.svg" alt="" />
          </a>
      ...
      <div class="main__center center">
        <div class="main__wrap">
          <h1 class="main__title title" data-aos="">
            <p>{CONTENTS.MAIN_HEADER_TITLE}</p>
          </h1>
          <div class="main__info" data-aos="animation-translate-up" data-aos-delay="200">{CONTENTS.MAIN_HEADER_DESCRIPTION}</div>
