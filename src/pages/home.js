      ...
      <div class="main">
        <div class="header js-header">
          <div class="header__center center">
            <a class="header__logo js-header-logo" href="index.html">
              <img class="header__pic" src="img/logo.png" alt="" />
            </a>
        ...
        <div class="main__center center">
          <div class="main__wrap">
            ...
            <div class="main__info" data-aos="animation-translate-up" data-aos-delay="200">Agency is a full-service ______, busy designing and building _________ digital products, brands, and ___________. </div>
        ...
        <div class="details__center center">
          <div class="details__head head">
            ...
            <div class="head__arrows arrows arrows_white" data-aos="animation-scale-y" data-aos-delay="400">
              ...
              </button></div><select class="head__select js-details-select">
              <option />2017
               <option />2018
               <option />2019
            ...
            <div class="details__container" data-aos="animation-translate-up">
              <div class="details__inner">
                <div class="details__slider js-details-slider">
                  <a class="details__preview" href="case.html"><img class="details__pic" src="img/details-pic-1.png" alt="" /></a>
                  <a class="details__preview" href="case.html"><img class="details__pic" src="img/details-pic-2.png" alt="" /></a>
                  <a class="details__preview" href="case.html"><img class="details__pic" src="img/details-pic-3.png" alt="" /></a>
                  <a class="details__preview" href="case.html"><img class="details__pic" src="img/details-pic-1.png" alt="" /></a>
                  <a class="details__preview" href="case.html"><img class="details__pic" src="img/details-pic-2.png" alt="" /></a></div>
              </div>
            </div>
          </div>
          <div class="details__foot">
            <div class="details__wrap">
              <h5 class="details__info h5" data-aos="animation-scale-y">A design team building _ curated marketplace for UI _________. </h5>
              <div class="details__text" data-aos="animation-scale-y" data-aos-delay="200">4,404 curated design resources __ energize your creative workflow. __'__ a growing family of 334,531 designers and makers from ______ the world </div>
        ...
        <div class="projects__center center">
          <div class="projects__head head">
            <div class="head__box">
              ...
              <div class="head__text" data-aos="animation-scale-y" data-aos-delay="400">Agency is a full-service ______, busy designing and building _________ digital products, brands, and ___________. </div>
            </div>
          ...
          <div class="projects__body">
            <div class="projects__desc">
              ...
              <h4 class="projects__info h4" data-aos="animation-scale-y" data-aos-delay="200">Sapiens: The Free Character _______ App. </h4>
              <div class="projects__text" data-aos="animation-scale-y" data-aos-delay="400">Beautiful library of modular, _________-_____ character illustrations free to ___ for all your personal __ client projects. </div><a class="projects__arrow arrow" data-aos="animation-scale-y" data-aos-delay="600" href="case.html">
      ...
      <footer class="footer">
        <div class="footer__center center">
          <div class="footer__body"><a class="footer__logo" href="index.html"><img class="footer__pic" src="img/logo.png" alt="" /></a>
            <div class="footer__text">Agency is a full-service ______, busy designing and building _________ digital products, brands, and ___________. </div>
          </div>
